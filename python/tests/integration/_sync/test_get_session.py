...
@pytest.mark.sync
def test_get_session_by_id(agent_bay_client):
    ...
    get_result = agent_bay_client.get(session_id)
    ...
    # Clean up
    agent_bay_client.delete(create_result.session)
...
@pytest.mark.sync
def test_list_sessions(agent_bay_client):
...
@pytest.mark.sync
def test_session_info(agent_bay_client):
