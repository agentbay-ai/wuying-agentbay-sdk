...
@pytest.fixture
def mobile_session(make_session):
...
@pytest.mark.sync
def test_get_adb_url_fails_on_non_mobile_image(agent_bay_client):
    ...
    result = agent_bay_client.create(params=params)
    ...
    try:
        ...
        try:
            agent_bay_client.delete(browser_session)
