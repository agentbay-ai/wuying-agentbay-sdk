...
class TestDeleteIntegration:
    ...
    @pytest.mark.sync
    def test_delete_without_params(self, agent_bay_client):
    ...
    @pytest.mark.sync
    def test_delete_with_sync_context(self, agent_bay_client):
    ...
    @pytest.mark.sync
    def test_agentbay_delete_with_sync_context(self, agent_bay_client):
