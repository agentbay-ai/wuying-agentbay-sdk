...
@pytest.mark.sync
def test_create_session_with_mobile_extra_configs_integration(make_session):
    ...
    try:
        ...
        session.mobile.set_navigation_bar_visibility(True)
        session.mobile.set_uninstall_blacklist(["com.android.systemui"])
