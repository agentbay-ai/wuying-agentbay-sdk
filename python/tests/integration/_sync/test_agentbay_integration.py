...
def agent_bay_client():
    """Lightweight fixture: constructs AgentBay without creating a session."""
...
# ---------------------------------------------------------------------------
# AgentBay – initialization (no network)
# ---------------------------------------------------------------------------
...
def test_get_whitespace_session_id(agent_bay_client: AgentBay):
...
def test_get_non_existent_session(agent_bay_client: AgentBay):
    """Test Get API with a non-existent session ID."""
    print("Testing Get API with non-existent session ID...")
    result = agent_bay_client.get("session-nonexistent-12345")
...
def test_get_api(agent_bay_client: AgentBay):
    ...
    try:
        ...
        result = agent_bay_client.get(session_id)
        ...
        delete_result = created_session.delete()
