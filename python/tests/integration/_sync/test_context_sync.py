...
def context_for_test(agent_bay_client):
...
@pytest.mark.sync
def test_recycle_policy_with_lifecycle_1day(agent_bay_client, context_for_test):
...
@pytest.mark.sync
def test_context_sync_and_info(agent_bay_client, context_for_test):
