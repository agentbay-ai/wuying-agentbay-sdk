...
@pytest.mark.sync
def test_context_sync_immediate_file_availability(agent_bay_client):
    """
    ...
    try:
        ...
        def collect_all_file_entries(ctx_id: str, folder_path: str, depth: int = 0) -> list:
            ...
            if depth > 5:
                return []
            result = agent_bay_client.context.list_files(
            ...
            for entry in result.entries:
                ...
                if file_type.upper() == "FOLDER":
                    ...
                    entries.extend(
                        collect_all_file_entries(ctx_id, next_path, depth + 1)
                    )
                else:
        ...
        all_entries = collect_all_file_entries(context_id, "/tmp/sync-test")
        ...
        try:
            ...
            delete_context_result = agent_bay_client.context.delete(context_obj)
