...
def setup_contexts(agent_bay_client):
...
def test_context_pagination_default(setup_contexts):
    ...
    list_result = agent_bay_client.context.list(params)
...
def test_context_pagination_second_page(setup_contexts):
    ...
    params = ContextListParams()
    params.max_results = 5
    first_page_result = agent_bay_client.context.list(params)
    ...
    if first_page_result.next_token:
        ...
        second_page_result = agent_bay_client.context.list(params)
...
def test_context_pagination_nil_params(setup_contexts):
    ...
    list_result = agent_bay_client.context.list(None)
