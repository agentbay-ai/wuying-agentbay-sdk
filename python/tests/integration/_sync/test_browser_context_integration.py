...
def browser_context_fixture():
    ...
    try:
        context = lc.create_context(context_name)
    except SessionLifecycleError as e:
...
@pytest.mark.sync
def test_browser_context_cookie_persistence(browser_context_fixture, make_session):
