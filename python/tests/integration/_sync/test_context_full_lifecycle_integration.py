...
class TestContextFullLifecycle:
    ...
    @pytest.mark.sync
    def test_context_full_lifecycle_single_session(self, agent_bay_client):
        """
        ...
        try:
            ...
            session_result = agent_bay_client.create(params=params)
    ...
    @pytest.mark.sync
    def test_context_cross_session_persistence(self, agent_bay_client):
        """
        ...
        try:
            ...
            session1_result = agent_bay_client.create(params=session1_params)
            ...
            session2_result = agent_bay_client.create(params=session2_params)
