...
@pytest.mark.sync
def test_context_create_and_delete(agent_bay_client):
    ...
    delete_result = agent_bay_client.context.delete(context)
    assert delete_result.success is True
    print(f"Deleted context: {context.id}")


@pytest.mark.sync
def test_context_get_existing(agent_bay_client):
    ...
    try:
        get_result = agent_bay_client.context.get(name=context_name)
...
@pytest.mark.sync
def test_context_list(agent_bay_client):
    ...
    try:
        list_result = agent_bay_client.context.list()
...
@pytest.mark.sync
def test_context_update(agent_bay_client):
    ...
    try:
        ...
        update_result = agent_bay_client.context.update(context)
...
@pytest.mark.sync
def test_context_with_session(make_session):
    ...
    context_result = lc.agent_bay.context.get(name=context_name)
