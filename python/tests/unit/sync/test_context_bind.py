...
def _mock_info_download_success(context_id="ctx-123", path="/tmp/test"):
    ...
    def _info(context_id=None, path=None, task_type=None):
...
class TestSyncContextManagerBindDownloadPolling(unittest.TestCase):
    def setUp(self):
        self.mock_session = MagicMock()
        self.mock_session._get_api_key.return_value = "test-api-key"
        self.mock_session._get_session_id.return_value = "test-session-id"
    ...
    @pytest.mark.sync
    def test_bind_waits_for_download_completion(self):
        ...
        def mock_list_bindings():
            return ContextBindingsResult(
                success=True,
                bindings=[ContextBinding(context_id="ctx-123", path="/tmp/test")],
            )

        def mock_info(context_id=None, path=None, task_type=None):
    ...
    @pytest.mark.sync
    def test_bind_no_download_polling_for_beta_context_mount(self):
    ...
    @pytest.mark.sync
    def test_bind_download_failure_returns_success(self):
    ...
    @pytest.mark.sync
    def test_bind_without_wait_skips_download_polling(self):
