...
class PtyHandle:
    ...
    def send_input(self, data: bytes) -> None:
        ...
        try:
            ...
            encoding = "base64"
        ws_client = self._pty_module._get_ws_client()
    ...
    def wait(self, timeout_s: Optional[float] = None) -> int:
        ...
        return asyncio.shield(self._exit_future)
...
class Pty:
    ...
    def _get_ws_client(self):
        if self._ws_client is None:
            self._ws_client = self._session._get_ws_client()
    ...
    def kill(self, pty_session_id: str) -> None:
