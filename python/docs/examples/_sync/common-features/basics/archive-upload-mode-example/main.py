...
def main():
    ...
    try:
        ...
        archive_exclude_paths_example(agent_bay, unique_id)
...
def archive_upload_mode_example(agent_bay, unique_id):
    ...
    try:
        ...
        list_result = agent_bay.context.list_files(context_result.context_id, sync_dir_path, max_results=10)
...
def archive_exclude_paths_example(agent_bay, unique_id):
    ...
    try:
        ...
        session.file_system.create_directory(f"{sync_path}/important")
        session.file_system.create_directory(f"{sync_path}/regular")
