...
def main() -> None:
    ...
    try:
        ...
        # Step 2: Read file
        print("\n[Step 2] Reading file...")
        read_result = fs.read_file(test_file)
        ...
        append_result = fs.write_file(
            test_file, "\nAppended line", "append"
        )
        if append_result.success:
            print("  Append successful")
            # Verify
            read_result2 = fs.read_file(test_file)
        ...
        edit_result = fs.edit_file(test_file, edits)
        if edit_result.success:
            print("  Edit successful")
            read_result3 = fs.read_file(test_file)
        ...
        dir_result = fs.create_directory(test_dir)
        ...
        move_result = fs.move_file(test_file, moved_path)
        ...
        fs.write_file(f"{test_dir}/report_jan.txt", "January report", "overwrite")
        fs.write_file(f"{test_dir}/report_feb.txt", "February report", "overwrite")
        fs.write_file(f"{test_dir}/data.csv", "Some CSV data", "overwrite")

        search_result = fs.search_files(test_dir, "*report*")
        ...
        multi_result = fs.read_multiple_files(file_paths)
        ...
        large_write_result = fs.write_file(large_path, large_content, "overwrite")
        ...
        start_time = time.time()
        large_read_result = fs.read_file(large_path)
